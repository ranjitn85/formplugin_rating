...
let NintexRating = _decorate([e$1('nintex-rating')], function (_initialize, _LitElement) {
  class NintexRating extends _LitElement {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
...
<div class="col-md-4">
  <div class="kpiblock">
    <div class="kpiheader">${this.Dagriddata}</div>
    <div class="kpibody"><img padding="5px" height="60px" width="60px" src="${this.Dagriddata}"/>   ${this.Dagriddata}</div>
  </div>
</div>
